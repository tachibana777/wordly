import type { Word, Score } from '../types';
export type AnswerResult = {status: 'empty'; score?: undefined; explanation?: undefined} | {status: 'correct' | 'partial' | 'unmatched'; score: Score; explanation?: string};
export const answers = {
    ...
    check(word: Word, answer: string): AnswerResult {
        ...
        const classify = (value: string): Score => {
        ...
        let score: number = classify(normalized);
        ...
        return { status: score === 1 ? 'correct' : score === 0.5 ? 'partial' : 'unmatched', score: score as Score,
