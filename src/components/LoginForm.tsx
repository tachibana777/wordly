...
export function LoginForm() {
  ...
  async function submit(event: FormEvent) {
    ...
    if (registering && ([...password].length < 8 || [...password].length > 128)) {setError('ใช้รหัสผ่าน 8–128 ตัวอักษร เช่น วลีหลายคำที่จำได้ง่าย');return;}
